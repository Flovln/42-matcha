...
class RegisterForm extends Component {
  ...
  handleSubmit(e) {
    ...
    if (username && first_name && last_name && email && password && confirmation) {
          ...
          <div className="container-fluid col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-4 register-form">
            ...
            <form onSubmit={this.handleSubmit}>
              <div className="form-group">
                ...
                <input type="username" className="form-control" id="usename" placeholder="Pick a username" name="username" onChange={this.handleChange}></input>
              </div>
              <div className="form-group">
              ...
              <div className="form-group"/*className={`form-group ${this.errorClass(this.state.formErrors.confirmation)}`}*/>
